...
class AdmRedes
{
	...
	{
		$sql="UPDATE red SET descRed='$descRed' WHERE idRed='$idRed'";
		return ejecutarConsulta($sql);
	}
	...
	{
		$sql="SELECT idRed, descRed FROM red WHERE idRed='$idRed'";
	...
	public function listaRedesxDisa($idDisa)
	{
		$sql="SELECT * FROM red WHERE disa_iddisa='$idDisa' ORDER BY descRed";
		return ejecutarConsulta($sql);
	}
}
