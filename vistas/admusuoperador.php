...
<!--Contenido-->
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
         Listado de Usuarios Operadores
         </h1>
      </section>
              ...
              <div class="box-header">
                ...
                <div class="panel-body" id="formularioregistros">
                  <form name="formulario" id="formulario" method="POST">
                    ...
                    <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                      <label>&nbsp</label></br>
                      <button class="btn btn-primary" type="button" name="btnValidaDni" id="btnValidaDni" onclick="buscarDniOperador()"><i class="fa fa-credit-card"></i> Buscar Dni</button>
                    </div>
  ...
  <div id="nuevoUsuarioOperador" class="modal fade" tabindex="-1" role="dialog">
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="box-body">
              ...
              <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <label>MicroRed</label>
                <select name="idmredUsu" id="idmredUsu" class="form-control selectpicker" data-live-search="true" onchange='cargarEstablUsu(this.value);'>
                  <option value="000000">Todas las MicroRedes</option>
                </select>
              </div>
              ...
              <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                <label>Establecimiento</label>
                <select name="idestabUsu" id="idestabUsu" class="form-control selectpicker" data-live-search="true">
                  <option value="0">Todos los Establecimientos</option>
                </select>
              </div>
              ...
              <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                ...
                <select name="idServ" id="idServ" class="form-control selectpicker">
...
<script type="text/javascript" src="scripts/admusuoperador.js"></script>