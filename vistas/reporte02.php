...
<!--Contenido-->
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1>
         Reporte de Gestantes con Fecha Probable de Parto - Siguientes 30 días
         </h1>
      </section>
              ...
              <div class="box-header">
                ...
                <div class="panel-body table-responsive" id="listadoregistros">
                  <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                   <label>Desde</label>
                   <input type="date" class="form-control" name="fechaIni" id="fechaIni" value="<?php echo date("Y-m-d"); ?>" disabled>
                  </div>

                  <div class="form-group col-lg-2 col-md-2 col-sm-2 col-xs-12">
                    <label>Hasta</label>
                    <input type="date" class="form-control" name="fechaFin" id="fechaFin" value="<?php echo date("Y-m-d",strtotime($diaActual."+ 30 days")); ?>">
                  </div>
                  ...
                  <table id="tbllistado" class="table table-sm table-striped table-bordered table-condensed table-hover" style="width:100%">
                    <thead>
                      <th>Apellidos y Nombres Gestante</th>
                      <th>Edad</th>
                      <th>Documento Ientificacion</th>
                      <th>Nro Celular</th>
                      <th>Fecha PP</th>
                      <th>Dias para el Parto</th>
                      <th>Disa/Geresa</th>
...
<script type="text/javascript" src="scripts/reporte02.js"></script>