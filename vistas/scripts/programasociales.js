...
function listar()
{
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax": {
			url: '../ajax/programasociales.php?op=listar',
			type: "get",
			dataType : "json",
			error: function (e){
...
function guardaryeditar(e)
{
	...
	$.ajax({
		url	: "../ajax/programasociales.php?op=guardaryeditar",
		type : "POST",
		data : formData,
		contentType : false,
		processData : false,
		...
		success: function(datos)
		{
			...
			{
				case '0':
				  mensaje='El Programa Social no se pudo Registrar.';
				  break;
				case '1':
				  mensaje='Programa Social Registrado.';
				  break;
				case 'E':
				  mensaje='El Programa Social que está Ingresando YA Existe.';
				  break;
			}
...
{
	$.post("../ajax/programasociales.php?op=mostrar",{idwsdat01 : idwsdat01}, function(data, status)
	{
...
{
	bootbox.confirm("¿Está seguro que desea eliminar El Programa Social?", function(result){
		if (result)
		{
			$.post("../ajax/programasociales.php?op=eliminar", {idwsdat01 : idwsdat01}, function(e){
				bootbox.alert(e);
				tabla.ajax.reload();
			});
		}
