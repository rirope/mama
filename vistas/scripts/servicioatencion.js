...
function listar()
{
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax": {
			url: '../ajax/servicioatencion.php?op=listar',
			type: "get",
			dataType : "json",
			error: function (e){
...
function guardaryeditar(e)
{
	...
	$.ajax({
		url	: "../ajax/servicioatencion.php?op=guardaryeditar",
		type : "POST",
		data : formData,
		contentType : false,
		processData : false,
...
{
	$.post("../ajax/servicioatencion.php?op=mostrar",{idwsdat01 : idwsdat01}, function(data, status)
	{
...
{
	bootbox.confirm("¿Está seguro que desea eliminar El Servicio?", function(result){
		if (result)
		{
			$.post("../ajax/servicioatencion.php?op=eliminar", {idwsdat01 : idwsdat01}, function(e){
				bootbox.alert(e);
				tabla.ajax.reload();
			});
		}
