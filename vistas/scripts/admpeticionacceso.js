...
function listar()
{
  ...
  if (idestab=='0'){
	...
	tabla=$('#tbllistado').dataTable(
	{
		...
		"ajax": {
			url: '../ajax/admpeticionacceso.php?op=listar',
...
function activar(idDet)
{
	bootbox.confirm("¿Está Seguro de activar al Usuario?</br>Se enviará un mensaje al correo del usuario sobre esta acción.", function(result){
	if(result)
  {
  	$.post("../ajax/admpeticionacceso.php?op=activar", {idDet : idDet}, function(e){
